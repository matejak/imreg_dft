...
project = u'imreg_dft'
copyright = u'2014, Christoph Gohlke, Matěj Týč'
...
latex_documents = [
  ('index', 'imreg_dft.tex', u'imreg\\_dft Documentation',
   u'Christoph Gohlke, Matěj Týč', 'manual'),
]
...
texinfo_documents = [
  ('index', 'imreg_dft', u'imreg_dft Documentation',
   u'Christoph Gohlke, Matěj Týč', 'imreg_dft', 'One line description of project.',
   'Miscellaneous'),
]
